        ...
        function createPost() {
            (async () => {
                ...
                if(txtField.length>1){
                    const rawResponse = await fetch('https://noticeboardapplication.herokuapp.com/api/create/post/1', {
                        method: 'POST',
                        headers: {
        ...
        function updatePost(postId,newPostText) {
            (async () => {
                ...
                const rawResponse = await fetch('https://noticeboardapplication.herokuapp.com/api/update/post/'+postId, {
                    method: 'Patch',
                    headers: {
                        'Accept': 'application/json',
                        'Content-Type': 'application/json'
        ...
        function getAllPosts() {
            ...
            (async () => {
                ...
                const rawResponse = await fetch('https://noticeboardapplication.herokuapp.comapi/fetch/post/all', {
                    method: 'Get',
                    headers: {
                        'Accept': 'application/json',
                        'Content-Type': 'application/json'
        ...
        function getCommentById(id,postDivId) {
            ...
            (async () => {
                ...
                const rawResponse = await fetch('https://noticeboardapplication.herokuapp.com/api/fetch/comment/' + id, {
                    method: 'Get',
                    headers: {
                        'Accept': 'application/json',
                        'Content-Type': 'application/json'
        ...
        function addUserInfoToComment(useraccountId,commentText,commentId,postId) {
            ...
            (async () => {
                ...
                const rawResponse = await fetch('https://noticeboardapplication.herokuapp.com/api/fetch/useraccount/' + useraccountId, {
                    method: 'Get',
                    headers: {
                        'Accept': 'application/json',
                        'Content-Type': 'application/json'
        ...
        function getPostById(id) {
            ...
            (async () => {
                ...
                const rawResponse = await fetch('https://noticeboardapplication.herokuapp.com/api/fetch/post/' + id, {
                    method: 'Get',
                    headers: {
                        'Accept': 'application/json',
                        'Content-Type': 'application/json'
